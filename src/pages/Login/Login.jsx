...
const Login = () => {
  ...
  return (
    <div className='bg-[#FCFAFA] flex justify-center items-center h-[100vh]'>
      ...
      <div>
        <h2 className='text-[#4F4F4F] mb-[53px] text-center text-[36px] font-semibold'>Welcome, Log into you account</h2>
        <div className='mx-auto max-w-[512px] text-center bg-white pt-[72px] px-[130px] pb-[39px]'>
          ...
          <form onSubmit={handleSubmitLogin} className='flex flex-col gap-[14px] mt-[14px]'>
